...
extension CardTemplate {
    static let defaultSeeds: [CardTemplateSeed] = [
        ...
        CardTemplateSeed(bankName: "信銀國際", type: "大灣區雙幣信用卡", colors: ["8A8F99", "E3DEE9"], region: .cn, specialRate: [ .other: 6], defaultRate: 4, foreignCurrencyRate: 0.4, localBaseCap: 150, foreignBaseCap: 0, categoryCaps: [.other: 250], capPeriod: .monthly),
